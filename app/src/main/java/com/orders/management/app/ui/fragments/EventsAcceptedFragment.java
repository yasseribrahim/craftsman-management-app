...
public class EventsAcceptedFragment extends Fragment implements EventsCallback, EventsViewerAdapter.OnEventsClickListener {
    private FragmentEventsAcceptedBinding binding;
    private EventsPresenter presenter;
    private EventsViewerAdapter usersAdapter;
    private List<Event> events, searchedEvents;

    public static EventsAcceptedFragment newInstance() {
        Bundle args = new Bundle();
        EventsAcceptedFragment fragment = new EventsAcceptedFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentEventsAcceptedBinding.inflate(inflater);
    ...
    public void onGetEventsComplete(List<Event> events) {
        this.events.clear();
        var currentEvents = StorageHelper.getCurrentUser().getEvents();
