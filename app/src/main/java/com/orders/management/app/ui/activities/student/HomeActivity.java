package com.orders.management.app.ui.activities.student;
...
import com.orders.management.app.ui.fragments.EventsViewerFragment;
import com.orders.management.app.ui.fragments.MoreFragment;
import com.orders.management.university.app.R;
import com.orders.management.university.app.databinding.ActivityHomeStudentBinding;
import com.orders.management.app.models.User2;
import com.orders.management.app.ui.fragments.EventsAcceptedFragment;
import com.orders.management.app.ui.fragments.EventsCreatedFragment;
import com.orders.management.app.ui.fragments.HomeFragment;
import com.orders.management.app.ui.fragments.NotificationsFragment;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void setupNavDrawer() {
                        ...
                        public void run() {
                            switch (item.getItemId()) {
                                ...
                                case R.id.nav_events:
                                    showFragment(EventsViewerFragment.newInstance(), R.id.container);
                                    binding.content.toolbar.setTitle(R.string.menu_events);
                                    break;
                                case R.id.nav_events_created:
                                    showFragment(EventsCreatedFragment.newInstance(), R.id.container);
                                    binding.content.toolbar.setTitle(R.string.menu_events_created);
                                    break;
                                case R.id.nav_events_accepted:
                                    showFragment(EventsAcceptedFragment.newInstance(), R.id.container);
                                    binding.content.toolbar.setTitle(R.string.menu_events_accepted);
                                    break;
        ...
        User2 user = StorageHelper.getCurrentUser();
        if (user != null) {
