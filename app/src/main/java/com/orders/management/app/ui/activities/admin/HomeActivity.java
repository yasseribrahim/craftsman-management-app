                        ...
                        public void run() {
                            switch (item.getItemId()) {
                                ...
                                case R.id.nav_events:
                                    showFragment(EventsFragment.newInstance(), R.id.container);
