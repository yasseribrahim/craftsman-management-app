...
import com.orders.management.university.app.databinding.FragmentUsersBinding;
...
import com.orders.management.app.ui.activities.admin.UserActivity;
import com.orders.management.app.ui.adptres.UsersAdapter;
...
public class UsersFragment extends Fragment implements UsersCallback, UsersAdapter.OnItemClickListener {
    ...
    public void onItemViewListener(int position) {
        User2 user = searchedUsers.get(position);
    }
    ...
    @Override
    public void onDeleteUserComplete(User2 user) {
    ...
    private void openUserActivity(User2 user) {
