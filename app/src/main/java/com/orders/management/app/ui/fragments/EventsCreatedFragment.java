...
import com.orders.management.university.app.databinding.FragmentEventsAcceptedBinding;
import com.orders.management.university.app.databinding.FragmentEventsCreatedBinding;
...
public class EventsCreatedFragment extends Fragment implements EventsCallback, EventsViewerAdapter.OnEventsClickListener {
    ...
    public static EventsCreatedFragment newInstance() {
        Bundle args = new Bundle();
        EventsCreatedFragment fragment = new EventsCreatedFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentEventsCreatedBinding.inflate(inflater);
        ...
        binding.btnAddNew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constants.ARG_OBJECT, new Event());
    ...
    @Override
    public void onGetEventsComplete(List<Event> events) {
        this.events.clear();
