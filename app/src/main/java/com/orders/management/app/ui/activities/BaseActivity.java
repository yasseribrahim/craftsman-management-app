...
import com.orders.management.app.ui.activities.admin.HomeActivity;
import com.orders.management.app.ui.fragments.ProgressDialogFragment;
        ...
        if (user != null) {
            switch (user.getType()) {
                ...
                case Constants.USER_TYPE_STUDENT ->
                        intent = new Intent(this, com.orders.management.app.ui.activities.student.HomeActivity.class);
                default ->
