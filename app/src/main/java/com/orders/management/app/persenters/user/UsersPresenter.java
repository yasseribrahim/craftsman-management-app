...
public class UsersPresenter implements BasePresenter {
    ...
    public void getUsersCount() {
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                long adminCount = 0, studentCount = 0;
                ...
                callback.onGetUsersCountComplete(adminCount, studentCount);
            }
    ...
    public void getUsers(int type) {
        ...
        listener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if (callback != null) {
                    Collections.sort(users, new Comparator<User2>() {
                        @Override
    ...
    public void getUserById(String id) {
        reference.child(id).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (callback != null) {
                    callback.onGetUserComplete(snapshot.getValue(User2.class));
                }
            }
