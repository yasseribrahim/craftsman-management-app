...
public class ChatId implements Parcelable {
    ...
    public ChatId(User2 user1, User2 user2) {
        this.user1 = user1;
        this.user2 = user2;
    }

    public User2 getOther(User2 user) {
    ...
    public void setUser1(User2 user1) {
        this.user1 = user1;
    }
    ...
    public void readFromParcel(Parcel source) {
        this.user1 = source.readParcelable(User2.class.getClassLoader());
        this.user2 = source.readParcelable(User2.class.getClassLoader());
    }

    protected ChatId(Parcel in) {
        this.user1 = in.readParcelable(User2.class.getClassLoader());
        this.user2 = in.readParcelable(User2.class.getClassLoader());
    }
