package com.craftsman.management.app.ui.activities.craftsman;
...
public class HomeActivity extends AppCompatActivity {
    private ActivityHomeCraftsmanBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHomeCraftsmanBinding.inflate(getLayoutInflater());
                        ...
                        public void run() {
                            switch (item.getItemId()) {
                                ...
                                case R.id.nav_services:
                                    ...
                                    break;
                                case R.id.nav_services_accepted:
                                    showFragment(ServicesAcceptedFragment.newInstance(), R.id.container);
                                    binding.content.toolbar.setTitle(R.string.menu_services_accepted);
                                    break;
