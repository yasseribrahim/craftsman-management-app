...
import com.craftsman.management.app.databinding.ItemRegisterBinding;
...
public class RegistersAdapter extends RecyclerView.Adapter<RegistersAdapter.ViewHolder> {
    ...
    public RegistersAdapter(List<User> users, OnItemClickListener listener) {
        this.users = users;
    ...
    public interface OnItemClickListener {
        ...
        void onDeleteItemViewListener(User user);
    }
