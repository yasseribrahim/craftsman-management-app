...
import com.craftsman.management.app.ui.adptres.StudentsAdapter;
import com.craftsman.management.app.R;
import com.craftsman.management.app.databinding.ActivityStudentsBinding;
...
public class StudentsActivity extends BaseActivity implements UsersCallback, StudentsAdapter.OnItemClickListener {
    ...
    private void load() {
        presenter.getUsers(Constants.USER_TYPE_CLIENT);
    }
